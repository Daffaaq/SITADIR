<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item @active('dashboardsupervisor/Rekap_Permission')">
                <a class="nav-link" href="{{ url('/dashboardsupervisor/Rekap_Permission') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/logout') }}" data-toggle="modal" data-target="#customLogoutModal">
